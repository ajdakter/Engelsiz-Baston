...
public class CustomNewsAdapter extends BaseAdapter {
    ...
    public CustomNewsAdapter(Activity activity, List<Listing> elementListing) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        rowView = elementsInflatter.inflate(R.layout.row_news_layout, null);
        elemets_text = rowView.findViewById(R.id.newsTitle);
