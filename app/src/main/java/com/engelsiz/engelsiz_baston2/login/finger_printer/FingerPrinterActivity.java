       ...
       // mHeadingLabel = (TextView) findViewById(R.id.headingLabel);
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            if(!fingerprintManager.isHardwareDetected()){
                ...
                mParaLabel.setText("Parmak İzi Tarayıcı, Cihazda algılanmadı");

            } else if (ContextCompat.checkSelfPermission(this, Manifest.permission.USE_FINGERPRINT) != PackageManager.PERMISSION_GRANTED){

                mParaLabel.setText("Parmak İzi Tarayıcıyı kullanmak için izin verilmedi.");

            } else if (!keyguardManager.isKeyguardSecure()){

                mParaLabel.setText("Ayarlardan Telefonunuza Kilit Ekleyin.");

            } else if (!fingerprintManager.hasEnrolledFingerprints()){

                mParaLabel.setText("Bu Özelliği kullanmak için en az 1 Parmak İzi eklemelisiniz");

            } else {

                mParaLabel.setText("Uygulamaya erişmek için parmağınızı tarayıcıya yerleştirin.");
